...
ship1.addEventListener('click', rotatShip1)
ship2.addEventListener('click', rotatShip2)
ship3.addEventListener('click', rotatShip3)
ship4.addEventListener('click', rotatShip4)
ship5.addEventListener('click', rotatShip5)
